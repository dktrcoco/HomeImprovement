    ...
    return (
        <div>
            <form action="/api/chores" method="post">
                <h2>Enter a Chore</h2>
                <input onChange={handleInputChange} type="text" className="form-control" name="chore" placeholder="What chore do you want to add?" />
                <input onChange={handleInputChange} type="text" className="form-control" name="choreOwner" placeholder="Who is responsible for this chore?" />
                <input onChange={handleInputChange} type="date" className="form-control" name="choreDate" placeholder="When does this chore need to be completed?" />
