    ...
    return (
        <div>
            <form action="/api/events" method="post">
                ...
                <input onChange={handleInputChange} type="text" className="form-control" name="event" placeholder="What event do you want to add?" />
                <input onChange={handleInputChange} type="date" className="form-control" name="eventDate" placeholder="When is this event taking place?" />
